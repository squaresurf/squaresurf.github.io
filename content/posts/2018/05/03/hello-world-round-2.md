...
will be to write a short blog post every day Monday through Friday. So as you can imagine, the quality of these posts
may be a bit low and the volume high. The hope is that as I force myself to write every weekday, that I will get
better at this process, and hopefully start to produce content that someone other than myself would find interesting to
read.
